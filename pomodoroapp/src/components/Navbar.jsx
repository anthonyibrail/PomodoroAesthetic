        ...
        <nav className='Navbar'> 
            <div className="navContainer">
                ...
                <div className='pomodoroAppIcon'>
                    ...
                    <div className='pomodoroAppTitle'>
                        POMODORO AESTHETIC
                    </div>

                </div>

                <label for='menuHamburguesa' className='navLabel'>
                    <svg width="32" height="22" viewBox="0 0 32 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <g clip-path="url(#clip0_13_236)">
                    <path fill-rule="evenodd" clip-rule="evenodd" d="M0 21.3333H32V17.7778H0V21.3333ZM0 12.4444H32V8.88889H0V12.4444ZM0 0V3.55556H32V0H0Z" fill="white"/>
                    </g>
                    <defs>
